...
where TABLE_NAME = '{2}'
    ...
    def call_tab_strategy(self, sql_result: Tuple):
        ...
        :return:
        """
        exec_schema_name = sql_result[0]
        sql_text = sql_result[1].read()
        sql_id = sql_result[2]
        executions = sql_result[4]
        first_load_time = sql_result[7]
        last_load_time = sql_result[8]
